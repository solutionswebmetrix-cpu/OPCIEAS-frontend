...
const headerNavItemClass = 'group relative inline-flex h-10 items-center gap-1 rounded-full border border-white/75 bg-white/75 px-3.5 font-sub text-sm font-medium leading-none text-navy shadow-sm transition-colors duration-200 hover:border-gold hover:bg-white/90 hover:text-gold';
const headerActionClass = 'inline-flex h-10 items-center gap-1.5 rounded-full border border-white/80 bg-white/80 px-3.5 font-sub text-sm text-navy shadow-sm transition-colors duration-200 hover:border-gold hover:bg-white/95 hover:text-gold';
    ...
    <>
      <motion.nav
        ...
        className={`fixed top-0 z-[1000] h-[82px] w-full transition-all duration-500 lg:h-[92px] ${
          isHomePage && !scrolled ? 'bg-transparent shadow-none backdrop-blur-0' : scrolled ? 'bg-white shadow-[0_4px_20px_rgba(0,0,0,0.08)]' : 'bg-white/80 backdrop-blur'
        }`}
      >
        <div className="container-x flex h-full items-center justify-between px-6 lg:px-8">
          ...
          <div className="relative hidden h-full items-center gap-3 lg:flex">
            ...
            <Link to="/catalogue" className={`${headerActionClass} gap-2 px-4`}><Download className="h-4 w-4" /> Catalogue</Link>
            <Link to="/rfq" className="btn-gold inline-flex h-10 items-center justify-center rounded-full border border-gold/80 px-5 py-0 font-sub text-sm shadow-sm transition-colors duration-200 hover:border-gold-3">Request Quote</Link>
          </div>
